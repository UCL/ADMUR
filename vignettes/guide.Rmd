...
legend(x=7500, y=max(spd1), lwd=2, col=col, bty='n', legend=c('Gaussian','Cauchy'))

plotPD(spd2)
lines(mod.sine, col=cols[1], lwd=2)
lines(mod.uniform, col=cols[4], lwd=2)
legend(x=7500, y=max(spd2),  lwd=2, col=col, bty='n', legend=c('Sinewave','Uniform'))

plotPD(spd3)
lines(mod.logistic, col=cols[1], lwd=2)
lines(mod.exp, col=cols[4], lwd=2)
legend(x=7500, y=max(spd3), lwd=2, col=col, bty='n', legend=c('Logistic','Exponential'))
